...
class ParameterPanel(QWidget):
    ...
    def init_ui(self):
        ...
        layout.addWidget(self.corner_group)
        ...
        # 固定翼專用設定群組（預設隱藏，切換到固定翼時顯示）
        self.fixed_wing_group = self.create_fixed_wing_panel()
        layout.addWidget(self.fixed_wing_group)
